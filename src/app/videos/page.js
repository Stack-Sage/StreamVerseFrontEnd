...
export default function Videos() {
  return (
    <main className="mb-20  flex-col relative mx-auto items-center justify-center flex rounded-lg min-h-screen pt-16 ">
      
      
      <div className="pt-4 text-center max-w-2xl mx-auto">
        <p className="text-neutral-700 text-lg dark:text-neutral-300 mb-4">
